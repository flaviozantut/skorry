...
class PostMakeCommand extends Command
{
    ...
    {
        return array(
            array('title', null, InputOption::VALUE_OPTIONAL, 'Title of post', null),
            array('type', null, InputOption::VALUE_OPTIONAL, 'article/page', null),
            array('comments', null, InputOption::VALUE_OPTIONAL, 'y/n', null),
            array('post', null, InputOption::VALUE_OPTIONAL, 'Content of post', null),
        );
    }
